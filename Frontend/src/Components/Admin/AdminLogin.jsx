    ...
    const handleFormSubmit = async (event) => {
        ...
        try {
            ...
            if (checking.data.success !== false) {
                localStorage.setItem("admin", JSON.stringify(checking.data));
                    ...
                    <div className="row">
                        <div className="col-12 col-md-6 bsb-tpl-bg-platinum">
                            <div className="d-flex flex-column justify-content-between h-100 p-3 p-md-4 p-xl-5">
                                ...
                                <img className="img-fluid rounded mx-auto " src="https://img.freepik.com/free-vector/tablet-login-concept-illustration_114360-7883.jpg?w=740&t=st=1706529733~exp=1706530333~hmac=e294cf3ddb40c7cfdb91565f09d19d6771116dba97922030183962a816cfd0d8" alt='' width="545" />
                            </div>
                        </div>
