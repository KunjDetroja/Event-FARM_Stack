...
import "./Css/OrganizationOtherEventCss.css"
...
function OrganizationOtherEvent() {
                    ...
                    <div className="row">
                        {isCol2Visible ? (
                            ...
                            >
                                ...
                                <br />
                                <div className="row">
                                    <p className="col-6 othercard_title">Filter</p>
                                    <div className="col-6">
...
export default OrganizationOtherEvent