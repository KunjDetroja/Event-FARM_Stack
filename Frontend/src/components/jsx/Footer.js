          ...
          <footer class="footer">
            ...
            <div class="footer-content">
              <div class="footer-content-column">
                <div class="footer-logo">
                  <Link class="footer-logo-link" to="/">
                    ...
                    <h1 style={{color:"white"}}>EventWiz</h1>
                  </Link>
                </div>
              ...
              <div class="footer-social-links">
                ...
                <Link class="footer-social-link linkedin" to="https://www.linkedin.com/in/kunjdetroja52" target="_blank">
                ...
                <Link class="footer-social-link twitter" to="/" >
                ...
                <Link class="footer-social-link youtube" to="/">
                ...
                <Link class="footer-social-link github" to="https://github.com/KunjDetroja/Event" target="_blank">
              ...
              <div class="footer-copyright-wrapper">
                <p class="footer-copyright-text">
                  <Link class="footer-copyright-link" to="/" target="_self">
                    {" "}
                    ©2024. | Designed By: Kunj Detroja. | All rights reserved.{" "}
                  </Link>
                </p>
              </div>
            </div>
