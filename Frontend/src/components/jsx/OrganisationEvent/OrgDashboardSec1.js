...
function OrgDashboardSec1() {
  ...
  const fetchdata = async () => {
    ...
    try {
      const response = await api.post("/orgdashboardcards", data);
...
export default OrgDashboardSec1;
